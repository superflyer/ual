ual=~/myprojects/ual
config=~/myprojects/ual/ual.config

#NRT-SIN
rm nrt-sin-*1.txt
paste <(date | $ual/src/date-add.py 3) <(echo '12/31/15') <(echo 'NRT	SIN		R') > nrt-sin-search1.txt
$ual/src/ual.py -u -c $config -a -o nrt-sin-results1.txt nrt-sin-search1.txt 
...
$ual/src/ual.py -u -c $config -a -o hkg-sfo-results.txt hkg-sfo-search.txt  
...
$ual/src/ual.py -u -c $config -a -o nrt-sin-results2.txt nrt-sin-search2.txt 
...
$ual/src/ual.py -u -c $config -a -o sin-hkg-results.txt sin-hkg-search.txt  
...
$ual/src/ual.py -u -c $config -a -o sfo-nrt-results.txt sfo-nrt-search.txt 
...
$ual/src/ual.py -u -c $config -a mr-search.txt -s 'Mileage run search results' 
